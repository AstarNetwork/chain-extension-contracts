...
mod rmrk_example {
    ...
    impl RmrkExample {
        ...
        #[ink(message)]
        pub fn priorities(&self, collection_id: CollectionId, nft_id: NftId, resource_id: ResourceId) -> Option<u32> {
            Rmrk::priorities(collection_id, nft_id, resource_id)
        }

        #[ink(message)]
        pub fn children(&self, parent: (CollectionId, NftId), child: (CollectionId, NftId)) -> Option<()> {
        ...
        #[ink(message)]
        pub fn equippable_bases(&self, collection_id: CollectionId, nft_id: NftId, base_id: BaseId) -> Option<()> {
        ...
        pub fn equippable_slots(
            ...
            Rmrk::equippable_slots(collection_id, nft_id, resource_id, base_id, slot_id)
        }

        #[ink(message)]
        pub fn properties(&self, collection_id: CollectionId, nft_id: Option<NftId>, key: Vec<u8>) -> Option<Vec<u8>> {
            Rmrk::properties(collection_id, nft_id, key)
        }
        ...
        pub fn create_collection(
            ...
            Rmrk::create_collection(metadata, max, symbol)
        }
        ...
        pub fn burn_nft(
            ...
            Rmrk::burn_nft(collection_id, nft_id, max_burns)
        }
        ...
        pub fn send(
            ...
            Rmrk::send(collection_id, nft_id, new_owner)
        }
        ...
        pub fn accept_nft(
            ...
            Rmrk::accept_nft(collection_id, nft_id, new_owner)
        }

        #[ink(message)]
        pub fn reject_nft(&mut self, collection_id: CollectionId, nft_id: NftId) -> Result<(), RmrkError> {
        ...
        pub fn set_property(
            ...
            Rmrk::set_property(collection_id, maybe_nft_id, key, value)
        }
        ...
        pub fn add_basic_resource(
            ...
            Rmrk::add_basic_resource(collection_id, nft_id, resource, resource_id)
        }
        ...
        pub fn add_composable_resource(
            ...
            Rmrk::add_composable_resource(collection_id, nft_id, resource, resource_id)
        }
        ...
        pub fn add_slot_resource(
            ...
            Rmrk::add_slot_resource(collection_id, nft_id, resource, resource_id)
        }
        ...
        pub fn accept_resource(
            ...
            Rmrk::accept_resource(collection_id, nft_id, resource_id)
        }
        ...
        pub fn remove_resource(
            ...
            Rmrk::remove_resource(collection_id, nft_id, resource_id)
        }
        ...
        pub fn accept_resource_removal(
            ...
            Rmrk::accept_resource_removal(collection_id, nft_id, resource_id)
        }
        ...
        pub fn set_priority(
            ...
            Rmrk::set_priority(collection_id, nft_id, priorities)
        }
    }
